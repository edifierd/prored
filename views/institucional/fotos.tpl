...
<div class="row" style="min-height:700px;">
	...
	<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4" style="height:350px;">
    	<div class="row" >
            ...
            <div class="col-xs-12 col-sm-12 col-md-12" >
            	<div class="row" style="margin-bottom: 10px;">
                	<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6" style="padding:0px; padding-right:5px;">
        				<img src="{$_layoutParams.root}views/institucional/fotos/thumbnails/foto{$galery.fotos[0]}.jpg"
